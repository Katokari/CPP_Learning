...
class clsDeveloper : public clsEmbloyee {
    private:
    ...
    , std::string title, std::string department, float salary, std::string mainProgrammingLanguage)
    : clsEmbloyee(id, firstName, lastName, email, phone, title, department, salary) {
...
int main() {
    clsDeveloper Developer(1, "Kato", "Meow", "kato@gmail.com", "0949137022", "Developer", "Game Dev", 2000, "C++");
    Developer.print();
    Developer.sendEmail("Hi", "How are you?");
    Developer.sendSMS("How are you?");
