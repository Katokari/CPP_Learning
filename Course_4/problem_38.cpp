...
void CopyArrOddNumbers(int originalArr[], int destArr[], int arrLength1, int& arrLength2) {
	arrLength2 = 0;
...
int main() {
	...
	CopyArrOddNumbers(arr1, arr2, arrLength1, arrLength2);
	cout << "Array2 after copy odd numbers : ";
